...
exports.ClockView = function (_a) {
    var type = _a.type, onDateChange = _a.onDateChange, onHourChange = _a.onHourChange, onMinutesChange = _a.onMinutesChange, onSecondsChange = _a.onSecondsChange, ampm = _a.ampm, date = _a.date, minutesStep = _a.minutesStep, ampmInClock = _a.ampmInClock;
    ...
    return (React.createElement(Clock_1.default, __assign({ date: date, ampmInClock: ampmInClock, onDateChange: onDateChange, type: type, ampm: ampm, minutesStep: minutesStep }, viewProps)));
};
exports.ClockView.displayName = 'ClockView';
// @ts-ignore
