...
var DayWrapper = function (_a) {
    ...
    return (React.createElement("div", __assign({ role: "presentation", onClick: dayInCurrentMonth && !disabled ? handleClick : undefined, onKeyPress: dayInCurrentMonth && !disabled ? handleClick : undefined, children: children }, other)));
};
